TARGET_TESTS = ci_test.py#kbase_obj_test.py appfile_test.py util_test.py report_test.py # ex ./ci_test.py
SERVICE = kb_picrust2
SERVICE_CAPS = kb_PICRUSt2
SPEC_FILE = kb_PICRUSt2.spec
URL = https://kbase.us/services/kb_picrust2
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
